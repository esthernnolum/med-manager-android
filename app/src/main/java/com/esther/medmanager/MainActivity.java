...
import com.esther.medmanager.PillsLedger.PillDetails;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent serverIntent = new Intent(MainActivity.this, AddMedActivity.class);
        ...
        pillsListView = (ListView) findViewById(R.id.pills_list_view);
    ...
    public void readMedData() {
        ...
        pillsListView.setAdapter(new MyAdapter(pillsLedger.pillsArrayList));
